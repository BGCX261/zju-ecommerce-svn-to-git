...
public class SellerViewServ extends HttpServlet{
	/**
	 * Constructor of the object.
	 */
	public SellerViewServ() {
		super();
	}
...
// TODO Auto-generated method stub
		...
		UsersDAO query=new UsersDAO();
		
		Users u = new Users();
		u = (Users)(query.findById(Integer.parseInt(userId)));
		System.out.println("store vire serv: the sotore name is :" + u.getUserName());
