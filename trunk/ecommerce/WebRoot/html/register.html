    ...
    <div class="m-nav">
    	<div class="layout960">
        	<ul class="channel">
                ...
                <li><a href="merchandisese.html">图书</a></li>
                <li><a href="merchandisese.html">数码</a></li>
                <li><a href="merchandisese.html">美食</a></li>
                <li><a href="merchandisese.html">服装</a></li>
            </ul>
...
<!-- header end -->
    ...
    <div class="layout960" id="register">
        ...
        <form action="" enctype="multipart/form-data" method="post">
            ...
            <p>
                <span class="reg_attr">邮箱：（学号邮箱？）</span>
            ...
            <p>
                <span class="reg_attr">移动虚拟网短号：</span>
                <input type="text" name="duanHao" />
            </p>
            <p>
