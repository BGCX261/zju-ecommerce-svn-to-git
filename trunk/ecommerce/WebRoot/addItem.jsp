...
<!-- header end -->
    ...
    <div class="layout960" id="addItem">
        ...
        <form action="AddItem.action" enctype="multipart/form-data" method="post">
            <p>
                <span class="reg_attr">类型：</span>
                <input type="radio" name="item_type" id="radio_new" value="0" checked="checked" ><label>全新</label></input>
                &nbsp;&nbsp;
                <input type="radio" name="item_type" id="radio_used" value="1" checked="false"><label>二手</label></input>
            </p>
            <p id="howOld">
